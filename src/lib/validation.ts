...
/** Admin adding a shift on behalf of someone: full poster details required. */
export const createShiftAdminSchema = z
  .object({
    poster_name: z.string().min(1, "Name is required"),
    poster_email: z.string().email("Invalid email"),
    poster_phone: z
...
export type CreateShiftAdminInput = z.infer<typeof createShiftAdminSchema>;
